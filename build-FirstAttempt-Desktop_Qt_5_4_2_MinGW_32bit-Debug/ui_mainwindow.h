...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        horizontalLayoutWidget->setGeometry(QRect(10, 10, 571, 321));
        EditorTabLayout = new QHBoxLayout(horizontalLayoutWidget);
        ...
        menuBar->setGeometry(QRect(0, 0, 1921, 26));
