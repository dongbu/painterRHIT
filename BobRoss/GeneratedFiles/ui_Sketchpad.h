...
public:
    ...
    void setupUi(QMainWindow *Sketchpad)
    {
        ...
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/Icon Storage/save.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/Icon Storage/FilledCircle.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionDraw_Filled_Circle->setIcon(icon7);
        ...
        QIcon icon8;
        icon8.addFile(QStringLiteral(":/Icon Storage/FilledSquare.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionDraw_Filled_Rectangle->setIcon(icon8);
        ...
        QIcon icon9;
        icon9.addFile(QStringLiteral(":/Icon Storage/FreeForm.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionDraw_Filled_Polygon->setIcon(icon9);
        actionStartup = new QAction(Sketchpad);
        actionStartup->setObjectName(QStringLiteral("actionStartup"));
        ...
        QIcon icon12;
        icon12.addFile(QStringLiteral(":/Icon Storage/webcam.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionLaunch_webcam->setIcon(icon12);
        ...
        menuConnect = new QMenu(menuRobot);
    ...
    void retranslateUi(QMainWindow *Sketchpad)
    {
        ...
        actionStartup->setText(QApplication::translate("Sketchpad", "startup", 0));
        ...
        menuConnect->setTitle(QApplication::translate("Sketchpad", "connect", 0));
